...
let loggedIn = true;
// abbreviated way of writing an if else statement in js
const greeting = loggedIn ? 'Welcome!' : 'Please login';
console.log(greeting)


//  legacy mnethod try not to use
...
// new es6 method (Note the required () siunce there are two params)
...
// implied returns shorten the syntax
...
//addint removing elmements from arrays
...
// for loops with arrays (indexing)
...
const init = () => {
    ...
    removeClass1Example.removeClass('class-1');
